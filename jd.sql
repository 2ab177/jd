...
CREATE TABLE jd_product(
  ...
  smproimg VARCHAR(128),
  lgproimg VARCHAR(128),
  typeimg VARCHAR(128),#京东精选，自营图片
  price DECIMAL(10,2),
  vipprice DECIMAL(10,2),
  buytype VARCHAR(10), #闪购，满减文字
  details VARCHAR(128),
  title VARCHAR(64)
);
...
/*******************/
/**商品列表**/
INSERT INTO jd_product VALUES(null,'../assets/wntj/1_sm.jpg','../assets/wntj/1_lg.jpg','../assets/zy.png',3988.00,3888.00,'闪购','【京东旗舰店+华为官方直供：全国联保+多重好礼(可联系客服折现)】【赠：10000毫安移动电源+真无线双耳蓝牙耳机+高品质运动手环等好礼】华为P30pro','华为P30手机 【白条6期免息0首付+20天价保+现货当天发+1年碎屏险】 天空之境 全网通 8G+128G(6期免息)'),
...
/**用户信息**/
INSERT INTO jd_login VALUES(null,'tom',md5('123'));
INSERT INTO jd_login VALUES(null,'jerry',md5('123'));
/**轮播图片**/
INSERT INTO jd_carousel VALUES(null,'../assets/lunbo/cal-1.jpg'),(null,'../assets/lunbo/cal-2.jpg'),(null,'../assets/lunbo/cal-3.jpg'),(null,'../assets/lunbo/cal-4.jpg'),(null,'../assets/lunbo/cal-5.jpg'),(null,'../assets/lunbo/cal-6.jpg'),(null,'../assets/lunbo/cal-7.jpg'),(null,'../assets/lunbo/cal-8.jpg');
/**京东秒杀**/
INSERT INTO jd_miaosha VALUES(null,'../assets/miaosha/ms1.jpg',299.00,399.00),(null,'../assets/miaosha/ms2.jpg',1299.00,1399.00)